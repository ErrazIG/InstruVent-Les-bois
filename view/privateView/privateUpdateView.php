...
<button type="button" class="btn btn-warning"><?=$message?></button><br>
  ...
  <div class="mb-3">
    ...
    <!-- type="datetime-local" -->
    <input name="userscreen" type="text"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required value="<?=$recupPost['userscreen']?>">
    <div id="emailHelp" class="form-text" max="160" min="6">utilisateur</div>
  </div>
